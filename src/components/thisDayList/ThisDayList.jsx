...
import { getWeatherThisDay } from "../../config";
...
function ThisDayList({city}) {
  ...
  function getWeather() {
    getWeatherThisDay(city).then((data) => setDataWeather(data))
  ...
  return (
    <div className="this-day-weather">
      {dataWeather === null ? <Spiner/> : <ThisDay  dataWeather={dataWeather} icon={icon}/>}
      {dataWeather === null ? <Spiner/> : <ThisDayInfo  dataWeather={dataWeather}/>}
